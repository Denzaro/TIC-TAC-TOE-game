...
"color: rgb(255, 210, 76)"));
        ...
        sound_4 = new QPushButton(centralwidget);
        sound_4->setObjectName("sound_3");
        sound_4->setGeometry(QRect(530, 0, 41, 31));
        sound_4->setStyleSheet(QString::fromUtf8("background-color: rgb(32,178,170);\n"
